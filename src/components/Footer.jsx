...
export default function Footer() {
  return (
    <footer className="border-t border-line bg-[#F2F6F7] text-navy">
      <Container className="py-16">
        <div className="grid gap-12 lg:grid-cols-[1.2fr_2fr]">
          <div>
            <Logo />
            <p className="mt-5 max-w-[32ch] text-sm leading-7 text-muted">
        ...
        <div id="privacy" className="mt-12 border-t border-line pt-6 text-sm text-muted">
          <p>
        ...
        <div id="terms" className="mt-3 text-sm text-muted">
          <p>
        ...
        <div className="mt-8 flex flex-col gap-2 border-t border-line pt-6 text-sm text-muted sm:flex-row sm:items-center sm:justify-between">
